...
module.exports = function () {
	...
	// output. 'Filed Undder <a href="articles/tech">tech</a>, <a href="articles/js">js</a>'
	...
	_helpers.postUrl = function (postSlug, options) {
		return ('/articles/post/' + postSlug);
	};

	// might be a ghost helper
	// used for pagination urls on articles
	_helpers.pageUrl = function (pageNumber, options) {
		return '/articles?page=' + pageNumber;
	};

	// create the category url for a articles-category page
